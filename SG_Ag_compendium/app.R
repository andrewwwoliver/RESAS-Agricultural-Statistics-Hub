...
# sub-section content ----
  ...
  observeEvent(input$btn_farm_types, {
    output$sub_section_content <- renderUI({
      fluidPage(
        tabsetPanel(
          ...
          tabPanel("Plot", h4("Farm Types Interactive Plots"),
                   #module UI
    ...
    plot_data_one <- reactive({farm_types %>% filter(main_farm_type != "All")})
  ...
  observeEvent(input$btn_labour, {
    output$sub_section_content <- renderUI({
      fluidPage(
        tabsetPanel(
          tabPanel("Summary",  h4("Labour Summary Content"),
                   HTML("<div style='margin-top: 20px; font-weight: 
                                   bold;'>Content under development</a></div>"),
                   HTML("<div style='margin-top: 20px; font-weight: 
                                    bold;'>Summary content for labour is within the
                                    <a href='https://www.gov.scot/collections/june-scottish-agricultural-census/' 
                                    target='_blank'>June Scottish Agricultural Census</a></div>")),
...
# Crops sub sections -------------------------------------------------------
  ...
  observeEvent(input$btn_crops_area, {
    output$sub_section_content <- renderUI({
      fluidPage(
        tabsetPanel(
          tabPanel("Summary",  h4("Crops Area Summary Content"),
                   HTML("<div style='margin-top: 20px; font-weight: 
                                   bold;'>Content under development</a></div>"),
                   HTML("<div style='margin-top: 20px; font-weight: 
                                    bold;'>Crops area summary content is within the
                                    <a href='https://www.gov.scot/collections/june-scottish-agricultural-census/' 
                                    target='_blank'>June Scottish Agricultural Census</a></div>")),
  ...
  observeEvent(input$btn_crops_production, {
    output$sub_section_content <- renderUI({
      fluidPage(
        tabsetPanel(
          tabPanel("Summary",  h4("Crops Production Summary Content"),
                              HTML("<div style='margin-top: 20px; font-weight: 
                                   bold;'>Content under development</a></div>"),
                              HTML("<div style='margin-top: 20px; font-weight: 
                                    bold;'> Crops production summary content is within the
                                    <a href='https://www.gov.scot/collections/june-scottish-agricultural-census/' 
                                    target='_blank'>June Scottish Agricultural Census</a></div>")),
